...
\titleabstract{Título em Ingles aqui}
\autor{NOME COMPLETO DO AUTOR}
\autorcitacao{citação} % Sobrenome em maiúsculo
...
\departamento{DACOM - DEPARTAMENTO ACADÊMICO DA COMPUTAÇÃO}
...
\instOrientador{Universidade do Orientador}
